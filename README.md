...
This repository has been trimmed down to the essentials needed to run a differential (diffy) swerve drivetrain on the FTC SDK. All other game-specific mechanisms and tools have been removed so you can focus on driving and tuning the base.
